        ...
        {FLOW_CHANNELS.map((channel) => {
          ...
          return (
            <Surface key={channel} className="p-5">
              ...
              <form action={addFlowRoute} className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <button className="btn-primary btn-sm sm:col-span-2" disabled={!eligible.length}>Add or replace route</button>
              </form>
