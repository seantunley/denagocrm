      ...
      {tab === "bot" && (
        <div className="max-w-3xl space-y-4">
          <p className="text-sm text-slate-400">
            Your chatbot answers customers on WhatsApp, Messenger, Instagram and Telegram — running
            the flow you design in the visual builder, with an AI assistant for open questions.
          </p>
            ...
            <div className="card space-y-3">
              ...
              <label className="flex items-center justify-between gap-4 cursor-pointer">
                <span>
                  ...
                  <span className="block text-xs text-slate-500">Grounded in your live prices, hours and the brief below; uses your FAQ pathways; hands off to a human when needed. Needs the Anthropic key (Integrations tab).</span>
                </span>
