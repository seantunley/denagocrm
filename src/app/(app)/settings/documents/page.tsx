...
export default async function DocumentsHubPage({
  ...
  // Free-form custom documents (separate from CRM-generated templates).
  ...
  const studioTab = (
    <div className="space-y-6">
      <div className="rounded-xl border border-sky-500/25 bg-sky-500/[0.06] p-4">
        <p className="text-sm font-semibold text-foreground">Custom documents</p>
        <p className="mt-1 max-w-3xl text-xs leading-5 text-muted-foreground">
          Use this free-form editor for once-off letters, confirmations and internal forms. These
          templates do not replace CRM-generated quotes, indemnities, invoices or job cards — edit
          those under <strong className="text-foreground">Generated templates</strong>.
        </p>
      </div>
      ...
      <div className="grid items-start gap-4 xl:grid-cols-2">
        {/* Templates */}
        <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
          <p className="mb-2 text-sm font-semibold text-foreground">Custom document templates</p>
  ...
  const templatesTab = (
    <div className="space-y-8">
      <div className="rounded-xl border border-primary/25 bg-primary/[0.06] p-4">
        <p className="text-sm font-semibold text-foreground">Templates used by the CRM</p>
        <p className="mt-1 max-w-3xl text-xs leading-5 text-muted-foreground">
          These control the actual documents opened from Quotes, Leads, Deliveries and Workshop.
          Edit the wording, branding, typography, colour, visible sections and signatures, preview
          against real data, then mark the design you want as Default.
        </p>
      </div>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-0.5 text-sm text-muted-foreground">
          Design the documents generated by the CRM, create custom one-off documents, and manage
          every stored PDF or uploaded file.
        </p>
      </div>
      ...
      <Tabs
        initialKey={tab}
        tabs={[
          { key: "templates", label: "Generated templates", content: templatesTab },
          { key: "studio", label: "Custom documents", count: studioDocs.length, content: studioTab },
          { key: "repository", label: "File repository", count: rows.length, content: repositoryTab },
        ]}
      />
    </div>
  );
