...
import { Bot, BookOpenCheck, BrainCircuit, GitBranch, Route } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <nav aria-label="Chatbot tools" className="flex flex-wrap gap-2 rounded-xl border border-border bg-card/60 p-2">
        <Link href="/chatbot" className="btn-secondary btn-sm"><Bot className="size-3.5" />Settings</Link>
        <Link href="/chatbot/knowledge" className="btn-secondary btn-sm"><BookOpenCheck className="size-3.5" />Knowledge</Link>
