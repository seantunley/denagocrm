...
function LoginInner() {
  ...
  if (state?.need2fa) return <TwoFactorStep methods={state.methods ?? []} />;
  ...
  return (
    <Shell>
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-400">Sign in to keep Cape Town moving.</p>
      </div>
        ...
        <form action={formAction} className="space-y-5">
          ...
          <Field label="Work email" htmlFor="email">
            <input
              ...
              type="email"
              autoComplete="email"
              placeholder="you@denagocpt.co.za"
    ...
    >
      ...
      <div className="relative flex h-full min-h-[680px] flex-col justify-between p-12 xl:p-16">
          ...
          <motion.div style={{ x: cardX, y: cardY }} className="relative rounded-[32px] border border-white/10 bg-white/[0.055] p-7 shadow-[0_40px_120px_rgba(0,0,0,.5)] backdrop-blur-xl xl:p-9">
            <div className="mb-10 flex items-start justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-medium tracking-tight">Cape Town hub</p>
              </div>
        ...
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-6 text-slate-500">The command centre for Denago sales, service and lasting customer relationships.</p>
        </div>
      </div>
    </section>
  );
