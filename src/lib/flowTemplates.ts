...
const SERVICE_FLOW: Flow = {
  ...
  nodes: {
    ...
    slot: { id: "slot", type: "slots", action: "book", text: "Choose one of the next available workshop times:", noneText: "There aren't open online slots just now — I'll log a service request so the team can call you.", next: "confirm", failureNext: "slotFallback" },
...
const BOOKING_MANAGEMENT_FLOW: Flow = {
  ...
  nodes: {
    ...
    newSlot: { id: "newSlot", type: "slots", action: "reschedule", text: "Choose a new workshop time:", noneText: "There aren't any open online times right now — I'll get the team to help you move it.", next: "moved", failureNext: "handoff" },
